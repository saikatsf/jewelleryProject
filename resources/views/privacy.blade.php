...
@section('content')
    <div class="row justify-content-center py-5">
        ...
        <div class="col-10 col-md-6">
            <div class="text-center h4">PRIVACY POLICY</div>
            <div class="py-3">
                We value the trust you place in jhumstaacreations.com . That's why we insist upon the highest standards for secure transactions and customer information privacy. Please read the following statement to learn about our information gathering and dissemination practices. Note: Our privacy policy is subject to change at any time without notice. To make sure you are aware of any changes, please review this policy periodically.
            </div>
            
            <div class="h5">COLLECTION OF PERSONALLY IDENTIFIABLE INFORMATION</div>
            <div class="py-3">
                We collect personally identifiable information (email address, name,phone number, etc.) from you when you set up an account with jhumstaacreations.com. While you can browse some sections of our site without being a registered member, certain sections do require registration. We do use your contact information to send you offers based on your previous orders and your interests.
            </div>

            <div class="h5">USE OF DEMOGRAPHIC AND PROFILE DATA</div>
            <div class="py-3">
            ...
            <div class="h5">COOKIES</div>
            <div class="py-3">
                A "cookie" is a small piece of information stored by a Web server on a Web browser so it can be later read back from that browser. Cookies are useful for enabling the browser to remember information specific to a given user. jhumstaacreations.com places both permanent and temporary cookies in your computer's hard drive. jhumstaacreations.com's cookies do not contain any of your personally identifiable information.
 
                Whether you want your web browser to accept cookies or not is up to you. If you haven't changed your computer's settings, most likely your browser already accepts cookies. You can also delete your browser cookies or disable them entirely. But this may significantly impact your experience with our website and may make parts of our website non functional or inaccessible. We recommend that you leave them turned on.
            </div>

            <div class="h5">SHARING OF PERSONAL INFORMATION</div>
            <div class="py-3">
                ...
                jhumstaacreations.com and its affiliates will share some or all of your personal information with another business entity should we (or our assets) plan to merge with, or be acquired by that business entity. Should such a transaction occur, that other business entity (or the new combined entity) will be required to follow this privacy policy with respect to your personal information.

            </div>

            <div class="h5">LINKS TO OTHER SITES</div>
            <div class="py-3">
                Our site links to other websites that may collect personally identifiable information about you. jhumstaacreations.com is not responsible for the privacy practices or the content of those linked websites.
            </div>

            <div class="h5">SECURITY PRECAUTIONS</div>
            <div class="py-3">
            ...
            <div class="h5">CHOICE/OPT-OUT</div>
            <div class="py-3">
                jhumstaacreations.com provides all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications from us on behalf of our partners, and from us in general, after setting up an account. If you are no longer interested in receiving e-mail announcements and other marketing information from us, or you want us to remove any information that we have collected about you, please e-mail your request to jhumstaacreations29g5@gmail.com
            </div>

            <div class="h5">ADVERTISING</div>
            <div class="py-3">
